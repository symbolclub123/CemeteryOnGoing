...
<head>
    ...
    <title>PCC-IMS - Informants Deceased</title>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-30 w-64 h-screen pt-20 transition-transform transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0">
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 rounded-lg mt-14">
            <h1 class="text-3xl text-primary font-semibold mb-4 "><?= ucfirst(strtolower($informant['fullname'])) ?> - Deceased Persons List</h1>
                ...
                <div class="flex justify-between items-center mb-3">
                    <div class="flex">
                        ...
                        <!-- <a href="select_block.php?user_id=<?= $curUser?>&iId=<?= $informant['informant_id'] ?>"
                            class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2">
                            Add Deceased
                        </a> -->
                ...
                <?php else: ?>
                    <div class="overflow-x-auto"  style="height: 55vh;">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 data-table">
                            ...
                            <tbody>
                                <?php foreach ($deceasedRecords as $deceasedRecord): ?>
                                    <tr>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['last_name'])) ?></td>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['first_name'])) ?></td>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['middle_name'])) ?></td>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['deceased_sex'])) ?></td>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['date_of_death'])) ?></td>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['block'])) ?></td>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['lots'])) ?></td>
                                        <td scope="col" class="px-6 py-3"><?= ucfirst(strtolower($deceasedRecord['relation'])) ?></td>
                                        <td class="px-6 !py-4">

                                            <a href="edit_deceased.php?user_id<?= $curUser ?>&iId=<?= $informant['informant_id'] ?>&DId=<?= $deceasedRecord['id'] ?>
                                            class="text-xs font-medium text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-info font-medium rounded-lg text-sm px-5 py-2.5 text-center"">Edit</a>
                                            <!-- Edit button -->
                                            <button type="button" data-modal-target="edit-deceased-<?= htmlspecialchars($deceasedRecord['id']) ?>-modal"
                                                data-modal-toggle="edit-deceased-<?= htmlspecialchars($deceasedRecord['id']) ?>-modal"
                                            ...
                                            <!-- Edit modal -->
                                            <div id="edit-deceased-<?= $deceasedRecord['id'] ?>-modal" tabindex="-1" aria-hidden="true"
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                data-modal-hide="edit-deceased-<?= $deceasedRecord['id'] ?>-modal">
                                                        ...
                                                        <form action="#" method="post">
                                                                ...
                                                                <div class="grid grid-cols-2 gap-4">
                                                                    <div class="flex flex-col border rounded p-3">
                                                                        ...
                                                                        <div class="grid grid-cols-3 gap-2 mb-3">
                                                                            <div class="mb-3">
                                                                                <input type="hidden" name="deceased_id" value="<?= $deceasedRecord['id'] ?>">
                                                                                ...
                                                                                <input type="text" id="first_name" name="first_name"
                                                                                    ...
                                                                                    value="<?= $deceasedRecord['first_name'] ?>" required />
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text" id="middle_name" 
                                                                                    name="middle_name"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['middle_name'] ?>" required />
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text" id="last_name" 
                                                                                    name="last_name"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['last_name'] ?>" required />
                                                                        ...
                                                                        <div class="grid grid-cols-2 gap-2 mb-3">
                                                                            ...
                                                                            <!-- <div>
                                                                                ...
                                                                                <input type="text" id="barangay" 
                                                                                    name="barangay"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['barangay'] ?>" required />
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input type="text" id="municipality" 
                                                                                    name="municipality"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['city_municipality'] ?>" required />
                                                                        ...
                                                                        <div class="grid grid-cols-3 gap-2 mb-3">
                                                                            ...
                                                                            <!-- <div>
                                                                                ...
                                                                                <input type="text" id="province" 
                                                                                    name="province"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['province'] ?>" required />
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input type="text" id="nationality" 
                                                                                    name="nationality"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['nationality'] ?>" required />
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input type="text" id="civil_status" 
                                                                                    name="civil_status"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['civil_status'] ?>" required />
                                                                        ...
                                                                        <div class="grid grid-cols-3 gap-2 mb-3">
                                                                            <div>
                                                                                ...
                                                                                <input type="text" id="occupation" 
                                                                                    name="occupation"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['occupation'] ?>" required />
                                                                            ...
                                                                            <select id="sex" name="sex" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                                                <option value="Male" <?php echo ($deceasedRecord['deceased_sex'] === 'MALE') ? 'selected' : ''; ?>>Male</option>
                                                                                <option value="Female" <?php echo ($deceasedRecord['deceased_sex'] === 'FEMALE') ? 'selected' : ''; ?>>Female</option>
                                                                            </select>
                                                                            </div>
                                                                            <div>
                                                                                <label for="religion" 
                                                                                ...
                                                                                <input type="text" id="religion" 
                                                                                    name="religion"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['religion'] ?>" required />
                                                                    ...
                                                                    <div class="flex flex-col border rounded p-3">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <input type="text" id="ref_number" 
                                                                                    name="ref_number"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['death_reference'] ?>" required />
                                                                        </div><br>
                                                                        <div class="grid grid-cols-3 gap-2 mb-3">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input type="text" id="relationship" 
                                                                                    name="relationship"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['relation'] ?>" required />
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input type="date" id="date_of_death" 
                                                                                    name="date_of_death"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['date_of_death'] ?>" required />
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input type="text" id="cause_of_death" 
                                                                                    name="cause_of_death"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['cause_of_death'] ?>" required />
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <input type="text" id="place_of_death" 
                                                                                    name="place_of_death"
                                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                                                    value="<?= $deceasedRecord['place_of_death'] ?>" required />
                                                            ...
                                                            <div
                                                                ...
                                                                <button data-modal-hide="edit-deceased-<?= $deceasedRecord['id'] ?>-modal"
                                                                    type="button"
                                                                    class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                                                                    Close
                                                                </button>
                                                                <!-- <button data-modal-hide="edit-deceased-1-modal" type="button"
                                                                    class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                                                                    Close
                                                                </button> -->
                                                            </div>
                                            ...
                                            <button type="button" data-modal-target="view-deceased-<?= htmlspecialchars($deceasedRecord['id']) ?>-modal"
                                                data-modal-toggle="view-deceased-<?= htmlspecialchars($deceasedRecord['id']) ?>-modal"
                                            ...
                                            <!-- Modal -->
                                            <div id="view-deceased-<?= htmlspecialchars($deceasedRecord['id']) ?>-modal" tabindex="-1" aria-hidden="true"
                                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative p-4 w-full max-w-4xl max-h-full">
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                            ...
                                                            <button type="button"
                                                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                                                                data-modal-hide="view-deceased-<?= htmlspecialchars($deceasedRecord['id']) ?>-modal">
                                                                ...
                                                                <div class="border rounded p-3">
                                                                    ...
                                                                    <table>
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>Name</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['first_name']))) ?> <?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['middle_name']))) ?> <?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['last_name']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Barangay</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['barangay']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>City/Municipality</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['city_municipality']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Province</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['province']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Sex</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['deceased_sex']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Religion</td>
                                                                                <td><?= htmlspecialchars($deceasedRecord['religion']) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Nationality</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['nationality']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Civil Status</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['civil_status']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Occupation</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['occupation']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Relationship to the Informant</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['relation']))) ?></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                                    ...
                                                                    <table>
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['death_reference']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Date of Death</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['date_of_death']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Cause of Death</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['cause_of_death']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Place of Death</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['place_of_death']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Block No</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['block']))) ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Lot No</td>
                                                                                <td><?= ucfirst(strtolower(htmlspecialchars($deceasedRecord['lots']))) ?></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                        ...
                                                        <div class="flex justify-end items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
                                                            <button data-modal-hide="view-deceased-<?= htmlspecialchars($deceasedRecord['id']) ?>-modal"
                                                                type="button"
                                                                class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                                                                Close
                                                            </button>
